...
import { TeacherForgot } from '../../redux/actions/teacher/teacherAuth';
...
export default function Forgot() {
	...
	const formik = useFormik({
		...
		onSubmit: async(values) => {
			dispatch(TeacherForgot(values, history));
		}
	});
			...
			<ContentStyle>
				...
				<FormikProvider value={formik}>
					<Form autoComplete="off" noValidate onSubmit={handleSubmit}>
						...
						<Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ my: 2 }}>
							<Link component={RouterLink} variant="subtitle2" to="/TeacherLogin">Login</Link>
						</Stack>
				...
				<MHidden width="smUp">
					<Typography variant="body2" align="center" sx={{ mt: 3 }}>
						Don’t have an account?&nbsp;
						<Link variant="subtitle2" component={RouterLink} to="/TeacherRegister">
						Get started
						</Link>
					</Typography>
				</MHidden>
